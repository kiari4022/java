...
public class YamadaDao {
	...
	public int insertPost(PostEntity Post) throws SQLException {
		String sql = "INSERT INTO post (userID,store, menu, price,date, jyuusho, train, picture, str) VALUES (?, ?,?, ?,?, ?,?, ?, ?)";
...
//			stmt.setInt(1, Post.getPostID());
			...
			stmt.setString(6, Post.getAddress());
			stmt.setInt(7, Post.getTime());
			stmt.setString(8, Post.getPhoto());
			stmt.setString(9, Post.getText());
