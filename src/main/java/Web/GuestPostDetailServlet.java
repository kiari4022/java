...
/**
 * Servlet implementation class GuestPostDetailServlet
 */
@WebServlet("/GuestPostDetailServlet")
public class GuestPostDetailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GuestPostDetailServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    // JSPにフォワード
	    String next = "GuestPostDetail.jsp";
